...
/* @pjs preload="img/synthesizer.jpg"; */
...
void setup()
{
  ...
  originalImage = loadImage("img/synthesizer.jpg");
  facebookLogo = loadImage("img/asset.f.logo.lg.png");
  cameraLogo = loadImage("img/cameraLogo.png");
  rotateLogo = loadImage("img/rotateLogo.png");
  ...
  tintImages[0] = loadImage("img/tintImage0.png");
  tintImages[1] = loadImage("img/tintImage1.png");
  tintImages[2] = loadImage("img/tintImage2.png");
  tintImages[3] = loadImage("img/tintImage3.png");

  overlays = new PImage[2];
  overlays[0] = loadImage("img/overlay1.png");
  overlays[1] = loadImage("img/overlay2.png");
